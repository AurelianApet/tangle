...
$(".rd-container").click(function () {
  changeVisible();
});

$(".ck-container").click(function () {
  changeVisible();
});
...
$(".custom-modal-content-close").click(function () {
  if (
    document.querySelector(".custom-modal-content-text").textContent ==
    "Thank you for your interest in tangle!\nWe aim to respond to your inquiry as soon as possible."
  ) {
    goto("index");
    return;
  }

  const modal = document.querySelector("#send");
